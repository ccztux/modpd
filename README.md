...
[![GitHub release (latest SemVer including pre-releases)](https://img.shields.io/github/v/release/ccztux/modpd?include_prereleases&label=latest%20pre-release)](https://github.com/ccztux/modpd/releases/tag/2.0.0)
...
# Example log:
```
2020-02-18 10:14:45 |   1677 | checkLogHandlerRequirements | modpd 2.0.0 starting... (PID=1677)
