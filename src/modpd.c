...
int nebmodule_init(int flags, char *args, nebmodule *handle) {
	...
	neb_set_module_info(modpd_module_handle, NEBMODULE_MODINFO_VERSION, "1.0.3-alpha7");
	...
	write_to_all_logs("modpd: Copyright (c) 2017 Christian Zettel (ccztux), Version: 1.0.3-alpha7", NSLOG_INFO_MESSAGE);
