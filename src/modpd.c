...
int nebmodule_init(int flags, char *args, nebmodule *handle)
{
	...
	neb_set_module_info(modpd_module_handle, NEBMODULE_MODINFO_VERSION, "2.2.6");
	...
	write_to_all_logs("modpd: Copyright © 2017-2020 Christian Zettel (ccztux), all rights reserved, Version: 2.2.6", NSLOG_INFO_MESSAGE);
